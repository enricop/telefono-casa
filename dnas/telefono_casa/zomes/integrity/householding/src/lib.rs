    ...
    match op.flattened::<EntryTypes, LinkTypes>()? {
        FlatOp::StoreEntry(store_entry) => match store_entry {
            OpEntry::CreateEntry { app_entry, action } => match app_entry {
                EntryTypes::Householder(householder) => {
                    validate_create_householder(EntryCreationAction::Create(action), householder)
                }
            },
            OpEntry::UpdateEntry {
                app_entry, action, ..
                ...
                EntryTypes::Householder(householder) => {
                    validate_create_householder(EntryCreationAction::Update(action), householder)
                }
            },
            ...
            OpUpdate::Entry { app_entry, action } => {
                ...
                match app_entry {
                    EntryTypes::Householder(householder) => {
                        ...
                        let original_householder = match Householder::try_from(original_app_entry) {
                            Ok(entry) => entry,
                            Err(e) => {
                                return Ok(ValidateCallbackResult::Invalid(format!(
                                    "Expected to get Householder from Record: {e:?}"
                                )));
                            }
                        };
                        validate_update_householder(
                            action,
                            householder,
                            original_create_action,
                            original_householder,
                        )
                    }
                }
            }
        ...
        FlatOp::RegisterDelete(delete_entry) => {
            ...
            match original_app_entry {
                EntryTypes::Householder(original_householder) => validate_delete_householder(
        ...
        FlatOp::RegisterCreateLink {
            ...
            LinkTypes::HouseholderUpdates => {
                validate_create_link_householder_updates(action, base_address, target_address, tag)
            }
        ...
        FlatOp::RegisterDeleteLink {
            ...
            LinkTypes::HouseholderUpdates => validate_delete_link_householder_updates(
                action,
                original_action,
                base_address,
                target_address,
            ...
            LinkTypes::AllHouseholds => validate_delete_link_all_households(
                action,
                original_action,
                base_address,
                target_address,
        ...
        FlatOp::StoreRecord(store_record) => {
            match store_record {
                ...
                OpRecord::CreateEntry { app_entry, action } => match app_entry {
                    EntryTypes::Householder(householder) => validate_create_householder(
                ...
                OpRecord::UpdateEntry {
                    ...
                    match app_entry {
                        EntryTypes::Householder(householder) => {
                            let result = validate_create_householder(
                                EntryCreationAction::Update(action.clone()),
                                householder.clone(),
                            )?;
                            if let ValidateCallbackResult::Valid = result {
                                let original_householder: Option<Householder> = original_record
                                    .entry()
                                    .to_app_option()
                                    .map_err(|e| wasm_error!(e))?;
                                let original_householder = match original_householder {
                                    Some(householder) => householder,
                                    None => {
                                        return Ok(
                ...
                OpRecord::DeleteEntry {
                    ...
                    match original_app_entry {
                        EntryTypes::Householder(original_householder) => {
                            validate_delete_householder(
                                action,
                                original_action,
                                original_householder,
                            )
                ...
                OpRecord::CreateLink {
                    ...
                    LinkTypes::HouseholderUpdates => validate_create_link_householder_updates(
                        action,
                        base_address,
                        target_address,
                        tag,
                    ),
                    LinkTypes::AllHouseholds => validate_create_link_all_households(
                        action,
                        base_address,
                        target_address,
                        tag,
